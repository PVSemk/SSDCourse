...
def train():
    ...
    if args.visdom:
        import visdom
        global viz # Solve NameError mistake
        viz = visdom.Visdom()
    ...
    if args.resume:
        ...
        #vgg_weights = torch.load(agrs.save_folder + args.basenet
        vgg_weights = torch.load('/content/CourseWork/SSDCourse/weights/' + args.basenet)
	...
	#Solve StopIteration issue
        ...
        if iteration != 0 and iteration % 5000 == 0:
            ...
            torch.save(ssd_net.state_dict(), agrs.save_folder + 'ssd300_COCO_' +
                       repr(iteration) + '.pth')
